...
DROP TABLE ACADEMY_COURSE_REGISTRATIONS CASCADE CONSTRAINTS;
DROP TABLE ACADEMY_COURSES CASCADE CONSTRAINTS;
DROP TABLE ACADEMY_STUDENTS CASCADE CONSTRAINTS;
DROP TABLE ACADEMY_TEACHER CASCADE CONSTRAINTS;
...
(
	...
	COURSE_quota number(3,0) NOT NULL,
	COURSE_REQ_CNT number(3,0) DEFAULT 0,
	-- 모집중, 모집완료, 과정취소 중 하나의 값만 허용된다.
...
COMMENT ON COLUMN ACADEMY_COURSES.COURSE_STATUS IS '모집중, 모집완료, 과정취소 중 하나의 값만 허용된다.';
